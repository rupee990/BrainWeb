...
void FAssetEditor_BrainWeb::CopySelectedNodes()
{
	...
	for (FGraphPanelSelectionSet::TIterator SelectedIter(SelectedNodes); SelectedIter; ++SelectedIter)
	{
		...
		if (UEdNode_BrainWebEdge* EdNode_Edge = Cast<UEdNode_BrainWebEdge>(*SelectedIter))
		{
			UEdNode_BrainWebNode* StartNode = EdNode_Edge->GetStartNode();
			UEdNode_BrainWebNode* EndNode = EdNode_Edge->GetEndNode();
