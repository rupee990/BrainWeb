#include "SEdNode_BrainWebEdge.h"
...
#define LOCTEXT_NAMESPACE "SBrainWebEdge"

void SEdNode_BrainWebEdge::Construct(const FArguments& InArgs, UEdNode_BrainWebEdge* InNode)
{
	this->GraphNode = InNode;
	this->UpdateGraphNode();
}

bool SEdNode_BrainWebEdge::RequiresSecondPassLayout() const
{
	return true;
}

void SEdNode_BrainWebEdge::PerformSecondPassLayout(const TMap< UObject*, TSharedRef<SNode> >& NodeToWidgetLookup) const
{
	UEdNode_BrainWebEdge* EdgeNode = CastChecked<UEdNode_BrainWebEdge>(GraphNode);
...
void SEdNode_BrainWebEdge::UpdateGraphNode()
{
	InputPins.Empty();
	OutputPins.Empty();
	...
	this->GetOrAddSlot( ENodeZone::Center )
		...
		[
			...
			[
				...
				.ColorAndOpacity( this, &SEdNode_BrainWebEdge::GetEdgeColor )
			]
			+SOverlay::Slot()
			[
				SNew(SImage)
...
void SEdNode_BrainWebEdge::PositionBetweenTwoNodesWithOffset(const FGeometry& StartGeom, const FGeometry& EndGeom, int32 NodeIndex, int32 MaxNodes) const
{
...
FSlateColor SEdNode_BrainWebEdge::GetEdgeColor() const
{
